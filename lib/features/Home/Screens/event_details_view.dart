...
class _EventDetailsViewState extends State<EventDetailsView> {
  ...
  Widget build(BuildContext context) {
    ...
    var time = DateFormat('h:mm a').format(widget.eventModel.dateTime);
    log(widget.eventModel.title);
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          GoRouter.of(
                            context,
                          ).push(AppRouter.editEvent, extra: widget.eventModel);
                        },
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  widget.eventModel.categoryModel.imagePath,
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "${widget.eventModel.dateTime.day} January",
